  ...
  const filteredCalls = useMemo(() => {
    ...
    return calls.filter(call => {
      ...
      if (searchQuery) {
        ...
        const matchesNumber = call.phone_number.toLowerCase().includes(query);
              ...
              >
                ...
                <div className="col-span-4 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {call.contact_name && (
                      <p className="text-xs text-gray-500 truncate">{call.phone_number}</p>
                    )}
                  </div>
                  {/* IVR Tags */}
                ...
                <div className="col-span-1 flex justify-center">
                  <Button
                    ...
                    size="icon"
                    className="h-8 w-8 rounded-full hover:bg-green-50"
                    onClick={() => navigate(`/dialer?number=${call.phone_number}`)}
